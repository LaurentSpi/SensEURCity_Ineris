...
outdir3 <-"C:/Users/diallo/OneDrive - INERIS/Documents/Ineris1/Stage_SensEURCity_final/OUTPUTS1/figs1/OPC_outliers_detection"
...
for (i in 1:nbr_groups){ # Loop over groups
  ...
  if (length(xc[!duplicated(xc)]) > 1 & length(xc) > 2) {
    ...
    # Plot	
    png(filename=paste0("C:/Users/diallo/OneDrive - INERIS/Documents/Ineris1/Stage_SensEURCity_final/OUTPUTS1/figs1/PMS_outliers_detection/","_04_Outliers_",Group,".png"), width=1000, height=600, type="cairo",bg = "white")
...
#            SAVE DATA              #          
#####################################
LCS_df_all_data_clean_groups_outliers <- dataout
save(LCS_df_all_data_clean_groups_outliers,file=paste0(outdir,"LCS_df_all_data_clean_groups_outliers.Rda"))
